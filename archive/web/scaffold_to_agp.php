...
<tr>
	<td style="vertical-align:top">
		...
		<? echo $found_name; ?>Scaffold to AGP	
		</div>
	...
	$filename = '/tmp/'.uniqid().".agp";
	$cmd = "perl scampi_agp.pl -s $scaffoldname -db inc/db_con.php -c ./inc/plugins/blast/contigs.fa -o $filename ";
	$print = shell_exec("$cmd");
	$enfile = base64_encode($filename);
	$enid   = base64_encode("scampi_$scaffoldname.agp.txt");
	print "<h3>Conversion to AGP</h3><br>$print<hr>";
	print "<a href=\"download.php?file=$enfile&id=$enid\">Download AGP file</a>\n";
